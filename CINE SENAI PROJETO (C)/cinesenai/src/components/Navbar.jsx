...
import { Link, useNavegate, useLocation, useNavigate } from "react-router-dom";
                    ...
                    {isAdmin() && (
                        ...
                        <div className="navbar-admin-section">
                            ...
                            Painel Admin
                             ...
                             <Link to="/admin-salas" className={`nav-link navbar-admin-link ${isActive("/admin/filmes")}`}>

                            Filmes

                            </Link>

                            <Link to="/admin-filmes" className={`nav-link navbar-admin-link ${isActive("/admin/salas")}`}>
                    ...
                    {user ? (
                        ...
                        <div className="navbar-user-info">
                            ...
                            <div className="navbar-user-badge">
                                ...
                                <span className="navebar-user-role">
