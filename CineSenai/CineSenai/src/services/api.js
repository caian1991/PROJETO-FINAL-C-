    ...
    auth: {
        ...
        avaliacoes: {
            ...
            listar: (filmeId) => request(`/api/filmes/${filmeId}/avaliacoes`), 
                ...
                criar: (filmeId, avaliacao) => request(`/api/filmes/${filmeId}/avalicoes`, {
                ...
                favoritos: {
                    ...
                    adicionarFavoritos: (filmeId) => request("/api/favoritos", {
                    ...
                    RemoverFavoritos: (filmeId) => request(`/api/favoritos/${filmeId}`, {

                        method: "DELETE",

                    }),

                    verificar: (filmeId) => request(`api/favoritos/
                    verificar?filmeId=${filmeId}`),
            ...
            usuario: {
                ...
                atualizarPerfil: (nome, email) => request("/api/ususario/perfil", {
